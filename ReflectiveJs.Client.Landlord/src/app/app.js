...
var cvApp = angular.module('cvApp', ['ui.router', 'ngCookies', 'config', 'breeze.angular', 'breeze.directives', 'templates-partials', 'masterIndex', 'mashboard', 'security', 'main', 'actionHandling', 'grid', 'list', 'initialDataLoaderService', 'persistence', 'datacaching', 'viewUtil'])
