angular.module('masterdetails')
    .directive('messagetemplatedetails', ['$rootScope',function ($rootScope) {
        return {
            restrict: 'E',
            ...
            templateUrl: 'app/views/maintain/custom/messagetemplatedetails.html',
            replace: true,
